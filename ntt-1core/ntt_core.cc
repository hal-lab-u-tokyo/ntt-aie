...
void vector_scalar_mul_scalar(int32_t *a, int32_t *c, int32_t *factor, int32_t N) {
  for (int i = 0; i < N; i++) {
    c[i] = *factor * a[i];
  }
}

void vector_scalar_mul_vectorized_int32(int32_t *a_in, int32_t *c_out, int32_t *factor, int32_t N) {
